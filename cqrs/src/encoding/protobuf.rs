...
impl<T> ProtoBuf<T> {
    /// Initializes a new [Protocol Buffers](ProtoBuf) message encoding for the specified [schema](Schema).
    ///
    /// # Arguments
    ///
...
impl<T: Encoded> ProtoBuf<T> {
    ...
    /// Initializes a new [Protocol Buffers](ProtoBuf) message encoding for a specific revision of the message type.
    ///
    /// # Remarks
    ///
